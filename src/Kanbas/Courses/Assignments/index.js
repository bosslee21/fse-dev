...
function Assignments() {
  ...
  return (
    <div
      className="col-9 col-lg-10 d-none d-sm-block"
      ...
      <div className="row">
        <div className="col d-flex   ">
          <input
            ...
            type="text"
            placeholder="Search for Assignement"
          ...
          <div className="justify-content-md-end">
            <button
              className="btn btn-secondary opacity-10"
              style={{ marginBottom: "2px", marginRight: 1 }}
            >
              <AiOutlinePlus style={{ color: "white" }} /> Group
            </button>
            <button
              className="btn btn-danger opacity-20"
              style={{ marginBottom: "2px", marginRight: 1 }}
              onClick={{}}
            >
        ...
        <div>
          <div className="list-group wd-assi-list-group">
            ...
            >
              {" "}
              <b style={{ marginRight: 450 }}> Assignements</b>
              <button
                type="button"
            ...
            {courseAssignments.map((assignment, index) => (
              <>
                ...
                >
                  ...
                  <p>
                    Week {index + 1} - Starting on {assignment.startDate}{" "}
                    <br></br> Due on {assignment.dueDate}{" "}
                  </p>
                </Link>
                <div className="d-flex flex-row">
                  ...
                  <div>
                    ...
                    >
                      <button
                        className="btn btn-warning float-middle"
                        style={{ marginLeft: 6 }}
                        onClick={() =>
